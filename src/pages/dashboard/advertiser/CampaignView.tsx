...
import { Campaign, getCampaignStatusBadge } from "./CampaignsPage";
...
export default function CampaignDetails() {
  ...
  const fetchCampaign = async () => {
    try {
      setLoading(true);
      const response = await api.get(`/advertiser/campaigns/${id}`);
              ...
              <CardContent>
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className="font-medium">
                      {campaign?.daily_conversion_cap || "No limit"}
                    </div>
                  </div>
                  <div>
                    <Label className="text-sm text-muted-foreground">
                    ...
                    <div className="font-medium">
                      {campaign?.monthly_conversion_cap || "No limit"}
                    </div>
                  </div>
                  <div>
                    <Label className="text-sm text-muted-foreground">
