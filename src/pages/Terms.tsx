...
export default function Terms() {
  return (
    <div className="min-h-screen flex flex-col">
      <Helmet>
        <title>Terms | AdLoot - Next-Gen Ad Network</title>
        <meta
          name="description"
          content="Terms | AdLoot - The next-gen ad network connecting advertisers with high-converting global traffic"
        />
        <meta name="author" content="AdLoot" />
        <meta
          name="keywords"
          content="adLoot Terms, adloot, offerwall, ad network, monetize apps, CPA network, CPI offers, mobile advertising, performance marketing, affiliate marketing, app monetization, reward ads, user acquisition, global traffic, best offerwall for websites, pay-per-install offers, TRC20 payouts, PayPal payouts, Heaven Gamers, advertisers platform, publisher monetization"
        />
        ...
        <link rel="canonical" href="https://adloot.io/terms" />
      </Helmet>
      <Navbar />
      <main className="flex-grow pt-24 pb-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-purple max-w-none">
            ...
            <p className="mb-4">
              Welcome to AdLoot.io. These Terms and Conditions govern your use
              of our website and services. By using AdLoot.io, you agree to
            ...
            <ul className="list-disc pl-6 mb-4">
              ...
              <li>
                "Service" refers to the AdLoot.io website and advertising
                platform.
              </li>
              <li>
              ...
              <li>
                "Publisher" refers to individuals or entities that display ads
                via our platform.
              </li>
              <li>
                "Advertiser" refers to individuals or entities that create and
            ...
            <p className="mb-4">
              Our Service provides an advertising platform connecting Publishers
              and Advertisers. You may use our Service only as permitted by law
              and according to these Terms. We reserve the right to modify or
            ...
            <p className="mb-4">
              ...
              Publishers must not artificially inflate impressions, clicks, or
              conversions. We reserve the right to withhold payment for
              fraudulent activity or violations of our terms.
            </p>

            <h2 className="text-xl font-semibold mb-4">6. Advertiser Terms</h2>
            <p className="mb-4">
              Advertisers are responsible for the content of their
              advertisements. All ad content must comply with our content
              policies and applicable laws. We reserve the right to reject or
              remove any advertisement at our discretion.
            </p>

            <h2 className="text-xl font-semibold mb-4">7. Payment Terms</h2>
            <p className="mb-4">
              Publishers will be paid according to our payment schedule and
              minimum payout thresholds. Advertisers agree to pay for campaigns
              as specified in their campaign settings. All fees are exclusive of
              applicable taxes, which are the responsibility of the user.
            </p>
            ...
            <p className="mb-4">
              ...
              amounts paid by you to us in the prior 12 months.
            </p>
            ...
            <p className="mb-4">
              ...
              Service. Your continued use of our Service after changes
