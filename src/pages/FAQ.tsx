...
export default function FAQ() {
  ...
  return (
    <>
      <Helmet>
        <title>FAQ's | AdLoot - Next-Gen Ad Network</title>
        <meta
          name="description"
          content="FAQ's | AdLoot - The next-gen ad network connecting advertisers with high-converting global traffic"
        />
        <meta name="author" content="AdLoot" />
        <meta
          name="keywords"
          content="adLoot faq, adloot, offerwall, ad network, monetize apps, CPA network, CPI offers, mobile advertising, performance marketing, affiliate marketing, app monetization, reward ads, user acquisition, global traffic, best offerwall for websites, pay-per-install offers, TRC20 payouts, PayPal payouts, Heaven Gamers, advertisers platform, publisher monetization"
        />
        ...
        <link rel="canonical" href="https://adloot.io/faq" />
      </Helmet>
              ...
              <Accordion type="single" collapsible className="w-full">
                ...
                <AccordionItem value="p2">
                  ...
                  <AccordionContent>
                    ...
                    Payments are made monthly, provided you've reached the
                    minimum payout threshold of ${settings?.min_withdrawal}.
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="p4">
                  ...
                  <AccordionContent>
                    ...
                    value and publishers maintain high-quality traffic
                    standards.
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
              ...
              <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="a1">
                  ...
                  <AccordionContent>
                    ...
                    campaigns through our dashboard. Define your target
                    audience, set your budget, upload creatives, and launch your
                    campaign. Our platform provides real-time reporting to
                    monitor performance.
                  </AccordionContent>
                </AccordionItem>
                <AccordionItem value="a2">
                  ...
                  <AccordionContent>
                    Our platform offers comprehensive targeting options
                    including geographic, demographic, device type, interests,
                    and behaviors. You can also create custom audiences and use
                ...
                <AccordionItem value="a3">
                  ...
                  <AccordionContent>
                    ...
                    scale up as you see results. We offer flexible pricing
                    models including CPI, CPA, and CPA.
                  </AccordionContent>
                </AccordionItem>
            ...
            <div>
              ...
              <Accordion type="single" collapsible className="w-full">
                ...
                <AccordionItem value="t3">
                  ...
                  <AccordionContent>
                    Yes, we are fully compliant with GDPR, CCPA, and other
                    global privacy regulations. Our platform includes built-in
                    consent management tools to help both publishers and
                    advertisers meet their compliance obligations.
                  </AccordionContent>
                </AccordionItem>
