...
export default function ReportsPage() {
  ...
  const campaignData = [
    { id: 1, name: "Summer Sale Promo", type: "Mobile App", impressions: 45892, clicks: 3241, conversions: 421, ctr: 7.06, cost: 1256.43 },
    { id: 2, name: "New User Acquisition", type: "Desktop Web", impressions: 32567, clicks: 2198, conversions: 312, ctr: 6.75, cost: 845.29 },
    { id: 3, name: "Brand Awareness", type: "Social Media", impressions: 58921, clicks: 4125, conversions: 529, ctr: 7.00, cost: 1578.67 },
    { id: 4, name: "Product Launch", type: "Mobile App", impressions: 27834, clicks: 1897, conversions: 243, ctr: 6.82, cost: 723.12 },
    { id: 5, name: "Holiday Special", type: "Desktop Web", impressions: 41265, clicks: 2876, conversions: 381, ctr: 6.97, cost: 1132.45 },
  ];
    ...
    <div className="space-y-8">
      ...
      <Tabs defaultValue="overview">
        ...
        <TabsContent value="demographics" className="min-h-[400px]">
          <Card className="h-full">
            <CardHeader>
              ...
              <CardDescription>Audience breakdown by age, gender, location</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="devices" className="min-h-[400px]">
          <Card className="h-full">
            <CardHeader>
              <CardTitle className="text-xl">Device & Platform Analysis</CardTitle>
              <CardDescription>Performance across different devices and platforms</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="flex items-center justify-center h-80">
                <p className="text-muted-foreground">Device distribution charts will be displayed here</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
