          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                The next-generation ad network connecting advertisers with
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
              <div>
                ...
                <p className="text-gray-600 mb-4">
                  Founded in 2023, AdLoot was created with a vision to
                  revolutionize the mobile advertising landscape. Our founders
                  recognized the challenges faced by both advertisers and
                  publishers in the digital ecosystem and set out to build a
                  platform that addresses these pain points with innovative
                  solutions.
                </p>
                <p className="text-gray-600">
                  Today, we've grown into a global network with thousands of
                  partners worldwide, connecting quality advertisers with
                  high-performing publishers through our advanced technology
                  platform.
                </p>
              </div>
              <div className="bg-purple-100 rounded-lg p-8">
                ...
                <p className="text-gray-700">
                  To empower digital advertisers and publishers with
                  transparent, efficient, and innovative advertising solutions
                  that drive measurable growth and maximize value for all
                  stakeholders.
                </p>
              </div>
            </div>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="bg-white p-6 rounded-lg shadow-md">
                  ...
                  <p className="text-gray-600">
                    ...
                    to stay ahead in the digital advertising landscape.
                  </p>
                </div>
                <div className="bg-white p-6 rounded-lg shadow-md">
                  <h3 className="text-xl font-bold text-purple-600 mb-3">
                  ...
                  <p className="text-gray-600">
                    We believe in open communication and full visibility into
                ...
                <div className="bg-white p-6 rounded-lg shadow-md">
                  ...
                  <p className="text-gray-600">
                    We view our clients as long-term partners and are committed
                    to their success through collaborative solutions.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 mb-8">
                Connecting advertisers and publishers across more than 180
                countries with our advanced targeting capabilities.
              </p>
