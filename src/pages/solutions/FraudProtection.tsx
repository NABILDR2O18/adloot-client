...
const FraudProtection = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Fraud Protection | AdLoot - Next-Gen Ad Network</title>
        <meta
          name="description"
          content="Fraud Protection | AdLoot - The next-gen ad network connecting advertisers with high-converting global traffic"
        />
        <meta name="author" content="AdLoot" />
        <meta
          name="keywords"
          content="adLoot Fraud Protection, adloot, offerwall, ad network, monetize apps, CPA network, CPI offers, mobile advertising, performance marketing, affiliate marketing, app monetization, reward ads, user acquisition, global traffic, best offerwall for websites, pay-per-install offers, TRC20 payouts, PayPal payouts, Heaven Gamers, advertisers platform, publisher monetization"
        />
        ...
        <link rel="canonical" href="https://adloot.io/fraud" />
      </Helmet>
