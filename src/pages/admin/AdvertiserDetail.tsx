...
export default function AdvertiserDetail() {
  ...
  const [advertiser, setAdvertiser] = useState({
    ...
    campaigns: 12,
    joined: "2023-04-15",
    lastLogin: "2023-06-01 09:45 AM",
    paymentMethods: [
      { type: "Credit Card", last4: "4242", expiry: "04/24", primary: true },
      { type: "PayPal", email: "finance@techinnovations.com", primary: false },
    ],
    recentActivity: [
      {
        type: "Deposit",
